...
export default function AuroraSignUp() {
  ...
  return (
    <div className="aurora-root">
      ...
      <main className="flex min-h-screen w-full bg-black selection:bg-white/30 p-2 transition-all duration-500 lg:h-screen lg:overflow-hidden lg:p-4 text-white antialiased">
        {/* --- Left Column (Hero) --- */}
